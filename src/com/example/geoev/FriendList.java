	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                String invited_final = new String(",");
                ArrayList<FBFriend> friendsList = friendListAdapter.friends;
                for(int i=0;i<friendsList.size();i++){
                FBFriend friend = friendsList.get(i);
                 if(friend.isSelected()){
                  responseText.append("\n" + friend.getName());
                  mySelectedFriends.add(friend.getUID());
                  //invited.append(friend.getUID() + ", ");
                 // String inv = invited.toString();
                 // invited_final = inv.substring(0,inv.length() - 2);
                 }
                }
                ...
                new Invite(getBaseContext()).execute("");
            	...
            	/*for(int h=0; h<friends.size();h++){
        			...
        			invitation.putString("uids", friends.get(h).getUID()); 
        			try {
	...
	class Invite extends AsyncTask<String, String, String>{
		 ...
		 ProgressDialog invitationDialog;
		    ...
		    protected void onPreExecute() {
		    	invitationDialog = new ProgressDialog(FriendList.this);
