...
public class AllGps_test extends Activity {
	//test
	private Timer timer;
   ...
   // private DataUpdateReceiver dataUpdateReceiver;
    ...
    public void showFBFriends() {
				...
				AllGps_test.this.runOnUiThread(new Runnable() {
				public void run() {
						Log.d(TAG, "run");
    ...
    public void showFBGpsData() {
				...
				public void run() {
						...
						for (GpsData gpsdata : singleton.getAllGpsData()) {
							TextView view = new TextView(
									getApplicationContext());
							Log.d(TAG, gpsdata.getTitle());
							view.setText(gpsdata.getTitle());
							view.setTextSize(16);
							rootView.addView(view);
					}
