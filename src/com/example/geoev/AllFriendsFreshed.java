...
public class AllFriendsFreshed extends Activity {
	//test
	private Timer timer;
   ...
   // private DataUpdateReceiver dataUpdateReceiver;
	...
	//tha to alakso oposdipote tha trexei opos kai i allevents class
    ...
    public void showFBFriends() {
				...
				AllFriendsFreshed.this.runOnUiThread(new Runnable() {
				public void run() {
						Log.d(TAG, "run");
