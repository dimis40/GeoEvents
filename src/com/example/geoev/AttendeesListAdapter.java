...
public class AttendeesListAdapter extends ArrayAdapter<FBFriend> implements SectionIndexer {
	...
	public AttendeesListAdapter(Context context, ArrayList<FBFriend> friends) {
		super(context, R.layout.list_item_attendee, friends);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			layout = inflater.inflate(R.layout.list_item_attendee, parent, false);
